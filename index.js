...
var _andersonmcook$crappy_magic_client$Main$initialItem = {title: 'yo', ownerName: 'hey', ownerEmail: 'what', videoCreatorName: 'sup', videoCreatorWebAddress: 'sup', videoCreatorEmail: 'sup', videoCreatorInstagramHandle: 'sup', price: 666.66, description: 'sup', materials: 'sup', manufactureInfo: 'sup', matureContent: false};
...
var _andersonmcook$crappy_magic_client$Main$Item = function (a) {
	return function (b) {
		return function (c) {
			return function (d) {
				return function (e) {
							...
							return function (h) {
								return function (i) {
									return function (j) {
										return function (k) {
											return function (l) {
												return {title: a, ownerName: b, ownerEmail: c, videoCreatorName: d, videoCreatorWebAddress: e, videoCreatorEmail: f, videoCreatorInstagramHandle: g, price: h, description: i, materials: j, manufactureInfo: k, matureContent: l};
											};
										};
									};
								};
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _andersonmcook$crappy_magic_client$Main$main !== 'undefined') {
    _andersonmcook$crappy_magic_client$Main$main(Elm['Main'], 'Main', {"types":{"unions":{"Dict.LeafColor":{"args":[],"tags":{"LBBlack":[],"LBlack":[]}},"Dict.Dict":{"args":["k","v"],"tags":{"RBNode_elm_builtin":["Dict.NColor","k","v","Dict.Dict k v","Dict.Dict k v"],"RBEmpty_elm_builtin":["Dict.LeafColor"]}},"Main.Msg":{"args":[],"tags":{"GetItem":["Result.Result Http.Error Main.Item"]}},"Dict.NColor":{"args":[],"tags":{"BBlack":[],"Red":[],"NBlack":[],"Black":[]}},"Http.Error":{"args":[],"tags":{"BadUrl":["String"],"NetworkError":[],"Timeout":[],"BadStatus":["Http.Response String"],"BadPayload":["String","Http.Response String"]}},"Result.Result":{"args":["error","value"],"tags":{"Ok":["value"],"Err":["error"]}}},"aliases":{"Http.Response":{"args":["body"],"type":"{ url : String , status : { code : Int, message : String } , headers : Dict.Dict String String , body : body }"},"Main.Item":{"args":[],"type":"{ title : String , ownerName : String , ownerEmail : String , videoCreatorName : String , videoCreatorWebAddress : String , videoCreatorEmail : String , videoCreatorInstagramHandle : String , price : Float , description : String , materials : String , manufactureInfo : String , matureContent : Bool }"}},"message":"Main.Msg"},"versions":{"elm":"0.18.0"}});
}
