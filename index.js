							...
							return function (h) {
								return function (i) {
									return function (j) {
										return function (k) {
											return function (l) {
												return {title: a, owner_name: b, owner_email: c, video_creator_name: d, video_creator_web_address: e, video_creator_email: f, video_creator_instagram_handle: g, price: h, description: i, materials: j, manufacture_info: k, mature_content: l};
											};
										};
									};
								};
...
var _andersonmcook$crappy_magic_client$Main$itemDecoder = A3(
									...
									A3(
										...
										A3(
											...
											A3(
												...
												'title',
												_elm_lang$core$Json_Decode$string,
												_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_andersonmcook$crappy_magic_client$Main$Item)))))))))))));
